...
//                               color: Colors.black))),
//                   DataColumn(
//                       label: Text('Verbose Name',
//                           style: TextStyle(
//                               fontWeight: FontWeight.w600,
//                               color: Colors.black))),
//                   DataColumn(
//                       label: Text('Verbose Name Plural',
//                           style: TextStyle(
//                               fontWeight: FontWeight.w600,
//                               color: Colors.black))),
//                   DataColumn(
...
//                               color: Colors.black))),
//                   DataColumn(
//                       label: Text('Show in Edit',
//                           style: TextStyle(
//                               fontWeight: FontWeight.w600,
//                               color: Colors.black))),
//                   DataColumn(
//                       label: Text('Show in Filter',
//                           style: TextStyle(
//                               fontWeight: FontWeight.w600,
//                               color: Colors.black))),
//                   DataColumn(
...
//                             DataCell(
//                                 Text(attributes['verbose_name'].toString())),
//                             DataCell(Text(
//                                 attributes['verbose_name_plural'].toString())),
//                             DataCell(Text(
//                                 attributes['required']?.toString() ?? "-")),
//                             DataCell(Text(
//                                 attributes['show_in_view']?.toString() ?? "-")),
//                             DataCell(Text(
//                                 attributes['show_in_report']?.toString() ??
//                                     "-")),
//                             DataCell(Text(
//                                 attributes['show_in_edit']?.toString() ?? "-")),
//                             DataCell(Text(
//                                 attributes['show_in_filter']?.toString() ??
//                                     "-")),
//                             DataCell(Text(
//                                 attributes['show_in_list']?.toString() ?? "-")),
//                             DataCell(Text(
//                                 attributes['show_in_add']?.toString() ?? "-")),
//                             DataCell(
//                               attributes['type'] == 'Choice' &&
//                                       attributes['choices'] != null
//                                   ? Container(
...
//                                             .colorScheme
//                                             .secondary,
//                                         value: (attributes['choices'] as List)
//                                                 .isNotEmpty
//                                             ? (attributes['choices'] as List)[0]
//                                                     [1]
//                                                 .toString()
//                                             : null,
...
//                             DataCell(Text(
//                                 attributes['related_name']?.toString() ?? "-")),
//                             DataCell(Text(
//                                 attributes['min_length']?.toString() ?? "-")),
//                             DataCell(Text(
//                                 attributes['max_length']?.toString() ?? "-")),
//                             DataCell(Text(
//                                 attributes['read_only']?.toString() ?? "-")),
//                             DataCell(Text(
//                                 attributes['max_digits']?.toString() ?? "-")),
//                             DataCell(Text(
//                                 attributes['decimal_places']?.toString() ??
//                                     "-")),
//                             DataCell(Text(
//                                 attributes['range_filter']?.toString() ?? "-")),
//                             DataCell(
//                                 Text(attributes['default']?.toString() ?? "-")),
//                             DataCell(Text(
//                                 attributes['multiple_filter']?.toString() ??
//                                     "-")),
//                             DataCell(Row(
//                               children: [
//                                 IconButton(
...
//                                         controller.formFields.indexOf(entry),
//                                         entry);
//                                   },
//                                 ),
//                                 IconButton(
...
//                           return DataRow(cells: [
//                             DataCell(Text(
//                                 '${controller.dynamicDetails.fields1 != null ? index : controller.itemFields.indexOf(entry) + 1}')),
//                             DataCell(Text(fieldName)),
//                             DataCell(Text(attributes['type'].toString())),
//                             DataCell(
//                                 Text(attributes['verbose_name'].toString())),
...
//                                   onPressed: () {
//                                     controller.editField(
//                                         controller.itemFields.indexOf(entry),
//                                         entry);
//                                   },
//                                 ),
//                                 IconButton(
...
// //                                     .map((DynamicModelsNameData item) {
// //                                   return DropdownMenuItem<String>(
...
// //                                         value: controller.selectedFields.isNotEmpty ? controller.selectedFields.first : null,
...
// //                                         return Chip(color: WidgetStatePropertyAll(Colors.white),
// //                                           label: Text(field),
...
// //                                 submitButtonText: controller.editingIndex >= 0 ? "Update Field" : "Add Field",
// //                                 submitButtonOnTap: () {
...
// //                                                             bool isDuplicate = controller.formFields.any((field) => field.containsKey(fieldName));
// //                                                             if (isDuplicate) {
// //                                                               toastification.show(
// //                                                                 context: context,
...
// //                                                                       () {
// //                                                                     print(
// //                                                                         "Printing the form fields Data::::::: ${jsonEncode(controller.itemFields)}");
// //                                                                     if (childFieldKey
// //                                                                             .currentState
// //                                                                             ?.validate() ??
// //                                                                         false) {
...
// //                                                                           progressBarTheme:
// //                                                                               ProgressIndicatorThemeData(linearMinHeight: 1),
// //                                                                           autoCloseDuration:
...
// //                                                                                 : null,
// //                                                                             items:
// //                                                                                 controller.fieldsList.map((Field item) {
// //                                                                               return DropdownMenuItem<String>(
// //                                                                                 value: item.name,
// //                                                                                 child: Row(
// //                                                                                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
